...
<div class="sl-pagebody">
  <div class="row">
    ...
    <div class="col-md-8">
      ...
      <form class="form-horizontal" id="employee-info-form" method="post" action="{{ route('store-customer.payment') }}">
        @csrf
        <div class="card">
            ...
            <div class="card-body card_form">
              ...
              <div class="form-group row custom_form_group{{ $errors->has('PayAmount') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-7">
                    <input type="text" placeholder="Input Amount" class="form-control" name="PayAmount" value="{{ old('PayAmount') }}">
              ...
              <div class="form-group row custom_form_group{{ $errors->has('Discount') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-7">
                    <input type="text" placeholder="Input Amount" class="form-control" name="Discount" value="{{ old('Discount') }}">
              ...
              <div class="form-group row custom_form_group{{ $errors->has('VoucharNo') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-7">
                    <input type="text" placeholder="Vouchar No" class="form-control" name="VoucharNo" value="{{ old('VoucharNo') }}">
              ...
              <div class="form-group row custom_form_group{{ $errors->has('PaymentDate') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-7">
                    <input type="date" class="form-control" name="PaymentDate" value="<?= date("Y-m-d") ?>">
