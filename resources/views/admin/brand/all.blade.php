...
@section('content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8">
                            <h4 class="card-title"><i class="fab fa-gg-circle"></i> All Brand Information</h4>
                        </div>
                        <div class="col-md-4 text-right">
                            <a href="{{route('brand-add')}}" class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i class="fas fa-plus-circle label-icon"></i>Add Brand</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
    ...
    <div id="softDelModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="post" action="{{url('dashboard/award/category/update')}}">
                @csrf
